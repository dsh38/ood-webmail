...
public class SmtpAgent {
    ...
    public boolean sendMessage() {
        ...
        log.debug("SMTP host : {}, auth : {}", props.get("mail.smtp.host"), props.get("mail.smtp.auth"));
        ...
        if (this.password != null && !this.password.isEmpty()) {
            session = Session.getInstance(props, new jakarta.mail.Authenticator() {
                ...
                protected jakarta.mail.PasswordAuthentication getPasswordAuthentication() {
                    return new jakarta.mail.PasswordAuthentication(userid, password);
                }
            });
        } else {
...
//            msg.setSubject(MimeUtility.encodeText(this.subj, "euc-kr", "B"));
            ...
            try {
                transport.connect(this.host, this.userid, this.password);
