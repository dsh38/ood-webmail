...
public class MessageFormatter {
    ...
    public String getMessageTable(Message[] messages) {
        ...
        for (int i = messages.length - 1; i >= 0; i--) {
            ...
            buffer.append("<tr> "
                    + " <td id=no>" + (i + 1) + " </td> "
                    + " <td id=sender>" + escapeHtml(parser.getFromAddress()) + "</td>"
                    + " <td id=subject> "
                    + " <a href=show_message?msgid=" + (i + 1) + " title=\"메일 보기\"> "
                    + escapeHtml(parser.getSubject()) + "</a> </td>"
...
//        return "MessageFormatter 테이블 결과";
    ...
    public String getMessage(Message message) {
        ...
        buffer.append("보낸 사람: " + escapeHtml(parser.getFromAddress()) + " <br>");
        buffer.append("받은 사람: " + escapeHtml(parser.getToAddress()) + " <br>");
        buffer.append("Cc &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : " + escapeHtml(parser.getCcAddress()) + " <br>");
        buffer.append("보낸 날짜: " + parser.getSentDate() + " <br>");
        buffer.append("제 &nbsp;&nbsp;&nbsp;  목: " + escapeHtml(parser.getSubject()) + " <br> <hr>");
